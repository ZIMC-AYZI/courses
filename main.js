...
//     } else if (airType === 'AX2022' && userTimeInMin >= aTerminal.g1Start && userTimeInMin <= aTerminal.g1End ||
...
//     } else if (airType === 'AX2022' && userTimeInMin >= aTerminal.g2Start && userTimeInMin <= aTerminal.g2End ||
//         userTimeInMin >= cTerminal.n43Start && userTimeInMin <= cTerminal.n43End) {
//         alert('Вы можете пройти в терминал А (ворота G2), либо в терминал C (ворота N43)')
//     } else if (airType === 'AX2022' && userTimeInMin >= aTerminal.g3Start && userTimeInMin <= aTerminal.g3End ||
...
//     } else if (airType === 'AX2022' && userTimeInMin <= cTerminal.n67Start && userTimeInMin >= cTerminal.n67End) {
//         alert('Вы можете пройти в терминал C (ворота N67)')
//     } else {
//         alert('Сосать плюс лежать')
//     }
// }
//
...
//
const test1 = ['123', 'test', 2, 'dildo', 'maramoyka', 'salo', 'rysna ymerla', '99'];
